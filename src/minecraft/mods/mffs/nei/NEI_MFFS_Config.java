 ...
 * 
 * MultiItemRange blocks = new MultiItemRange(); MultiItemRange items = new
 * MultiItemRange(); MultiItemRange upgrades = new MultiItemRange();
 ...
 * API.addSetRange("MFFS.Items.Modules", modules); API.addSetRange("MFFS.Items",
 * items); API.addSetRange("MFFS.Blocks", blocks);
 * 
 * 
 * 
 * }
 * 
 * @Override public String getName() { return "MFFS"; } public String
 * getVersion(){ return Versioninfo.curentversion(); }
 * 
 * }
 */